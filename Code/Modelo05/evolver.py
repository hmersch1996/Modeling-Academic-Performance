...
class Evolver():
    ...
    #Aqui inicializamos la clase, es necesario introducir el dato all_possible_genes al principio
    def __init__(self, all_possible_genes, retain=0.15, random_select=0.1, mutate_chance=0.3):
        ...
        #set the ID gen
        self.ids = IDgen()
    #Esta funcion crea una poblacion de redes aleatorias, count es la cantidad de redes a crear    
